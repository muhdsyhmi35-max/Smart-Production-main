...
/** Plan vs actual with one point per clock hour (single calendar day selected). */
...
function renderGraphCharts() {
  ...
  const WORKING_HOURS_PLAN = 8;
  let oeeChart;
  if (periodKeys.length === 1 && hourlyOutputVals && hourlyOutputVals.length) {
    ...
    oeeChart = buildSummaryLineChart(
